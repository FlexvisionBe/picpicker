...
<ul id="buttons_dl">
	<li>
		<a href="./assets/js/form_nike.js" target="_blank" download="form_nike.js">
		télécharger le <strong>js</strong>
		</a>
	</li>
	<li>
		<a href="./assets/less/form.less" target="_blank" download="form.less">
...
<div id="replace_names">afficher names</div>
...
<div class="sortable">
<div class="category manual_increment" data-group="children_group_erer" data-this-cpt="0">
	<div>
		<?php for($i=1;$i<=3;$i++) : ?>
		<?php
			if($i==1){$lang="fr";}
