/*
$(".form").each(function(){
	var contenu = $(this).html().replace(/[<]/g,"&lt"); 
	
	$("<pre>"+contenu+"</pre>").insertAfter($(this));
});
*/
...
$(document).ready(function() {
	$('#slider_header').slider_nike({'drag':1,'liquide':1,'isolement': 1,"loop":1,"nbr_li":1,"auto":1,"responsive":""});
});/* doc ready */
