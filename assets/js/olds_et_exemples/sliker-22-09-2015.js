...
plugin.init = function() {
	...
	//créer un afficheur statique pour mobile
	if (mobile != false && plugin.settings.creer_afficheur == 1) {
...
plugin.reset = function() {
	...
	//départ alternatif si spécifié par la classe start_slide (à mettre sur un li)
